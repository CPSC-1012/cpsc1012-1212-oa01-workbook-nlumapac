...
namespace AdditionQuiz
{
    internal class Program
    {
        ...
        {
            // Define constants for the Minimum number and Maximum number
            ...
            int number1 = rand.Next(MinNumber, MaxNumber + 1); // Add 1 because max value 
            ...
            // Display true if answer is correct, otherwise, display false
